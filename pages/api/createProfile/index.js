...
const handler = async (req, res) => {
    ...
    const starkPublicKey = req.body.starkPublicKey;
    ...
    try {
        ...
        await userCollection.updateOne({address: {$eq: address}}, { $set: {handle: handle, starkPublicKey: starkPublicKey, memeIndex: memeIndex}});
