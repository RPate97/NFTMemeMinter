...
export function EmptyCollection() {
    ...
    return (
        <Flex flexDirection="row" justifyContent="center" alignContent="center" height="350" width="100vw" mt={10}>
            <Box width="300" height="300" borderRadius="3xl" overflow="hidden">
                <Image src="/thats-a-bummer.jpeg" alt="that's a bummer man" width="300" height="300"/>
            </Box>
